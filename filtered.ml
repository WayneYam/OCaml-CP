...
module Lib = struct
  module Tree = struct
    ...
    include struct
      ...
      let rec node_of_sexp : 'a. (Sexplib0.Sexp.t -> 'a) -> Sexplib0.Sexp.t -> 'a node =
        ...
        fun _of_a__001_ ->
          ...
          Sexplib0.Sexp_conv_record.record_of_sexp
              ...
              (Field
                 ...
                 ; rest =
                     Field
                       { name = "adj"
                       ; kind = Required
                       ; conv = list_of_sexp (node_of_sexp _of_a__001_)
                       ; rest = Empty
                       }
                 })
            ...
            ~create:(fun (data, (adj, ())) -> ({ data; adj } : _ node))
            x__004_
      ;;

      let _ = node_of_sexp

      let rec sexp_of_node : 'a. ('a -> Sexplib0.Sexp.t) -> 'a node -> Sexplib0.Sexp.t =
        fun _of_a__005_ ->
        fun { data = data__007_; adj = adj__009_ } ->
        let bnds__006_ = ([] : _ Stdlib.List.t) in
        let bnds__006_ =
          let arg__010_ = sexp_of_list (sexp_of_node _of_a__005_) adj__009_ in
          (Sexplib0.Sexp.List [ Sexplib0.Sexp.Atom "adj"; arg__010_ ] :: bnds__006_
           : _ Stdlib.List.t)
        in
        let bnds__006_ =
          let arg__008_ = _of_a__005_ data__007_ in
          (Sexplib0.Sexp.List [ Sexplib0.Sexp.Atom "data"; arg__008_ ] :: bnds__006_
           : _ Stdlib.List.t)
        in
  ...
  include struct
    ...
    let t_of_sexp =
      (let error_source__017_ = "bin/aac1/p4_submit.ml.Pair_int.t" in
       ...
       | sexp__016_ ->
         Sexplib0.Sexp_conv_error.tuple_of_size_n_expected error_source__017_ 2 sexp__016_
       : Sexplib0.Sexp.t -> t)
    ;;
    ...
    let sexp_of_t =
      (fun (arg0__018_, arg1__019_) ->
         ...
         Sexplib0.Sexp.List [ res0__020_; res1__021_ ]
       : t -> Sexplib0.Sexp.t)
    ;;
    ...
    let (hash_fold_t : Ppx_hash_lib.Std.Hash.state -> t -> Ppx_hash_lib.Std.Hash.state) =
      ...
      let hsv = hash_fold_int hsv e1 in
      hsv
    ;;
...
let () =
  ...
  let queries =
    List.sort ~compare:(fun (a__028_ : int * int * int * int) ->
      fun (b__029_ : int * int * int * int) ->
